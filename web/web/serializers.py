...
from .models import Ingredient, Product, Production, ProductionIngredients, Recipe, SupplyItem
...
class ProductionSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        for ingredient in ingredients:
            ProductionIngredients.objects.create(production=production, **ingredient)
